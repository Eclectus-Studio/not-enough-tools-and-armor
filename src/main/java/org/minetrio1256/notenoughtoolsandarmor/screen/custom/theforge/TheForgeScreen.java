...
public class TheForgeScreen extends AbstractContainerScreen<TheForgeMenu>  {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Main.MOD_ID,"textures/gui/theforge/theforge_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Main.MOD_ID,"textures/gui/theforge/arrow_progress.png");
